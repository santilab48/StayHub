export default function MyRoomPreview(){
  return <main className="wrap">
    ...
    <section className="section card"><div className="toolbar"><div><h3>☎️ เบอร์โทร</h3><p className="muted">กดชื่อเพื่อโทรออก</p></div></div><div className="myRoomPhoneGrid"><a className="myRoomPhoneLink" href="tel:021234567"><span>🏢</span><strong>สำนักงาน / เจ้าของ</strong><small>แตะเพื่อโทรออก</small><b>›</b></a><a className="myRoomPhoneLink" href="tel:0812345678"><span>🛡️</span><strong>รปภ.</strong><small>แตะเพื่อโทรออก</small><b>›</b></a><a className="myRoomPhoneLink" href="tel:1669"><span>🚨</span><strong>ฉุกเฉิน</strong><small>แตะเพื่อโทรออก</small><b>›</b></a></div></section>
