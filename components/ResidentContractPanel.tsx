...
export default function ResidentContractPanel(){
 ...
 return <>
  ...
  {lease.final_pdf_path&&<section className="section card"><strong>มี PDF Final แล้ว</strong><p className="muted">เปิดไฟล์ได้จากพื้นที่เอกสารของห้องตามสิทธิ์ผู้เช่า</p></section>}
 </>
}
